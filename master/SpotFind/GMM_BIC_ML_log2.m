...
function [BestModel, numComponents_BIC] = GMM_BIC_ML_log2(data, GMM_models_tested, shared_cov)
...
for k = 1:GMM_models_tested
    GMModels{k} = fitgmdist(data,k,'Options',options,'Replicates',30,'SharedCovariance', shared_cov);
