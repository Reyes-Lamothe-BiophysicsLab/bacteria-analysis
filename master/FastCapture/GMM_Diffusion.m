...
function [DataInx,BestModel,cc] = GMM_Diffusion (data,GMM_models_tested)
...
DataInx = [data,idx];
figure 
histogram (data,'BinWidth',0.25,'Normalization','pdf','BinLimits',[-10,4])
hold on
%ylim([0 0.5])
...
y = pdf(BestModel, x);
plot(x, y)
title('GMM Fit of Log of Apparent Diffusion Coefficient')
