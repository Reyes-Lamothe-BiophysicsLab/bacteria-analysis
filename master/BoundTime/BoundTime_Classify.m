...
disp(mean_speed);
if length(quest_tr) == 3
Fraction_factorsS = inputdlg('Speed Factor', 'Fraction Factors', [1 100],{'0.3515'});
else
...
for i = 1:length(filename_new_data)
    ...
    tracks_prediction1 = tracks_2(pred_isolate, :);
    ...
    spotted{i}=spots;
    data_tracks_pred1{i} = [{tracks_prediction1}, {prediction_class1}, {new_data_2},{new_data_4},{spots}];
end 
...
Fraction_factorsQ = inputdlg('Quality Factor', 'Fraction Factors', [1 100],{'2.6444'});
pred_used_2_class = str2num(cell2mat(pred_used_class));
else
...
for i = 1:length(Tracks_cell_TR)
    ...
    tracks_prediction2 = Tracks_2(pred_isolate, :);
    mew_Data_4 = mew_Data_3(pred_isolate,:);
    ...
    data_tracks_pred2 = struct('Tracks_pred1',tracks_prediction1,'Tracks_pred2',tracks_prediction2, 'Prediction_class1',prediction_class1, 'Prediction_class2', prediction_class2,'Training_Scaled1',new_data_2,'Training_Scaled2',mew_Data_2,'TrainingFinal1',new_data_4,'TrainingFinal2',mew_Data_4,'Filtered_Spots',spots);
