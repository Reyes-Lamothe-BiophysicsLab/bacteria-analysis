...
function [DataInx,BestModel] = GMM_RoG (data,GMM_models_tested)
...
DataInx = [data,idx];
figure 
histogram (data,'BinWidth',0.5,'Normalization','pdf')
hold on
%ylim([0 0.5])
...
y = pdf(BestModel, x);
plot(x, y)
title('GMM Fit of Log of Apparent Radius of Gyration')
